...
import { LearnEnglishBlock as LearningProps } from '@/payload-types'
import { ArrowRight } from 'lucide-react'
import React from 'react'

export const LearnEnglishBlock: React.FC<LearningProps> = ({
  cards,
  title,
  richText,
  backgroundColor,
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 px-10 mt-20 md:px-20 container mx-auto">
          {cardData.map((card, index) => (
            ...
            >
              ...
              <div className="relative mx-auto flex items-center top-44 text-white px-4">
